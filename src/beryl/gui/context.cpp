...
#include "beryl/gui/publicsans.h"
#include "beryl/config/config_gui.h"
#include "beryl/utils/path_utils.h"
#include "beryl/logging/logger.h"

void beryl::gui::Context::LoadFonts(std::filesystem::path& executable_path, float font_size)
{
...
void beryl::gui::Context::UpdateDockspaceFlags(const bool custom_title_bar)
{
...
beryl::gui::Context::Context(GLFWwindow* window)
{
...
void beryl::gui::Context::PreRender() const
{
...
void beryl::gui::Context::PostRender() const
{
    ImGui::Render();
...
void beryl::gui::Context::ChangeFontSize() const
{
    ImGui::GetStyle()._NextFrameFontSizeBase = m_font_size;
}

void beryl::gui::Context::UpdateTheme() const
{
...
void beryl::gui::Context::AddHeaderHeight(float height)
{
