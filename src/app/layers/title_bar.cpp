...
#include "app/icons/titlebar_logo.h"

void app::layer::TitleBar::DrawWindowButton(
    ImVec2& cursor_pos, 
...
bool app::layer::TitleBar::IsMaximized(GLFWwindow* window)
{
    return glfwGetWindowAttrib(window, GLFW_MAXIMIZED) != 0;
}

app::layer::TitleBar::TitleBar(beryl::core::Application* app) 
...
void app::layer::TitleBar::RefreshTheme()
{
    m_is_light_theme = (m_app->m_gui_context->m_theme == "Light");
    UpdateTitleBarColor();
    LoadButtonTextures(true);
...
void app::layer::TitleBar::OnRender()
{
...
void app::layer::TitleBar::MenuBar()
{
...
void app::layer::TitleBar::HandleBorderResize()
{
...
void app::layer::TitleBar::UpdateTitleBarColor()
{
...
void app::layer::TitleBar::LoadButtonTextures(bool reload)
{
...
void app::layer::TitleBar::DrawCenteredText(std::string& text, const ImRect& rect)
{
